...
* we focus on one quantitative trait (namely \texttt{qt1} in the package) the two SNPs rs10 and rs6585 and the covariates sex and age
...
* Extensions to a mixed-model framework will allow the incorporation of multiple independent studies to perform a meta-analysis
